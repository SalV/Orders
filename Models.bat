rails generate scaffold Inventory inv_id:string s_desc:string l_desc:text image_path:string origin:string qty_on_hand:integer qty_on_order:integer qty_available:integer product_type:string sale_price:real
rails generate scaffold Company company_id:string company_name:string address1:string address2:string city:string state:string postal_code:string country:string phone1:string phone2:string fax:string dba:string business_since:date contact_name:string contact_email:string sales_tax_id:string credit_status:string comments:text business_type:string
