...
describe "trx_details/new" do
  before(:each) do
    assign(:trx_detail, stub_model(TrxDetail,
      :line_no => 1,
      :trx_id => "MyString",
      :item_id => "MyString",
      :quan_ordered => 1,
  ...
  it "renders new trx_detail form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => trx_details_path, :method => "post" do
